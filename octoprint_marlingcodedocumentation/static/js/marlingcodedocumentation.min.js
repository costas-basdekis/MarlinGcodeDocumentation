...
var DocumentationService = /*#__PURE__*/function () {
  function DocumentationService() {
    ...
    var allGcodesDate = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : window.AllGcodesDate;
...
$(function () {
  function MarlingcodedocumentationViewModel(parameters) {
    ...
    self.allGcodesDate = ko.observable(window.AllGcodesDate); // Since the terminal VM is bound on `value`, we would only get an
    ...
    self.favourites = ko.computed(function () {
      ...
      return docItemsList = favouriteCommands.map(function (id) {
        var _self$documentationSe;

        return (_self$documentationSe = self.documentationService.allGcodesById[id]) !== null && _self$documentationSe !== void 0 ? _self$documentationSe : [id, null];
      }).map(function (_ref34) {
        ...
        var docItem = _ref36.docItem;
        return !docItem || visibleSources.includes(docItem.source);
      });
    });
    ...
    self.toggleFavourite = function (_ref37) {
      ...
      var command = _ref37.command,
          docItem = _ref37.docItem;
      var oldFavouriteCommands = self.favouriteCommands();
      var id = (_docItem$id = docItem === null || docItem === void 0 ? void 0 : docItem.id) !== null && _docItem$id !== void 0 ? _docItem$id : command;
    ...
    self.onUpdateDocumentation = function () {
      OctoPrint.simpleApiCommand("marlingcodedocumentation", "update-documentation", {}).done(function (data) {
    ...
    self.refreshDocumentation = function () {
      OctoPrint.simpleApiGet("marlingcodedocumentation").done(function (data) {
        self.documentationService.update(data, null);
        self.allGcodesDate(self.documentationService.allGcodesDate);
      });
    };
