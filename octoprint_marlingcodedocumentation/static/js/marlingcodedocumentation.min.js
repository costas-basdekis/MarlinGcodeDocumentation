// Compiled with https://babeljs.io/en/repl#?browsers=&build=&builtIns=false&spec=false&loose=false&debug=false&forceAllTransforms=false&shippedProposals=false&circleciRepo=&evaluate=false&fileSize=false&timeTravel=false&sourceType=module&lineWrap=true&presets=es2015%2Cstage-2&prettier=false&targets=&version=7.12.12&externalPlugins=
"use strict";
...
var GcodeParser = /*#__PURE__*/function () {
  ...
  _createClass(GcodeParser, [{
    ...
    value: function stripComments(line) {
...
var KlipperExtendedGcodeParser = /*#__PURE__*/function () {
  ...
  _createClass(KlipperExtendedGcodeParser, [{
    ...
    key: "stripComments",
    // Remove anything after a semi-colon to the end of the line, including preceding spaces
    // http://linuxcnc.org/docs/html/gcode/overview.html#gcode:comments
    // Comments can be embedded in a line using parentheses () or for the remainder of a lineusing a semi-colon. The semi-colon is not treated as the start of a comment when enclosed in parentheses.
    value: function stripComments(line) {
